...
public class FirstEntryInRowIteratorTest {
	...
	private static long process(TreeMap<Key, Value> sourceMap, TreeMap<Key, Value> resultMap, Range range,
			IteratorSetting iteratorSetting) throws IOException {
	...
	public void test() throws IOException {
		...
		numNexts = process(sourceMap, resultMap, new Range(new Key("r1"), (new Key("r2")).followingKey(PartialKey.ROW)),
				iteratorSetting);
