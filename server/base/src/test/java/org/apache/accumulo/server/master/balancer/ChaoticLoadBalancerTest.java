...
public class ChaoticLoadBalancerTest {
	...
	public ChaoticLoadBalancer mockChaoticLoadBalancer1() {
		ChaoticLoadBalancer mockInstance = Mockito.spy(ChaoticLoadBalancer.class);
		try {
	...
	public void testAssignMigrations() {
		...
		ChaoticLoadBalancer balancer = mockChaoticLoadBalancer1();
	...
	public void testUnevenAssignment() {
		...
		// Just want to make sure it gets some migrations, randomness prevents guarantee
		// of a defined
