...
public class SizeWindowTest {
	...
	static public SizeWindow mockSizeWindow1(Map<String, Integer> testData) {
		SizeWindow mockInstance = Mockito.spy(new SizeWindow(convert(testData)));
		try {
	...
	public void testSlide() {
		...
		SizeWindow tsw = SizeWindowTest.mockSizeWindow1(testData);
